...
export default function BackupPanel() {
  ...
  const [loadingDownloadImages, seLoadingDownloadImages] = useState(false);
        ...
        <div className="flex flex-col gap-8 pt-4">
          ...
          <div className="flex flex-col border border-white/20 p-6 rounded-xl gap-4">
            ...
            <Button
              ...
              disabled={loadingDownloadImages}
              variant="ghost"
            ...
            >
              ...
              <div className="text-center">
                <div className="font-semibold text-lg flex items-center justify-center gap-2">
                  Descargar Imagenes de la biblioteca
                  {loadingDownloadImages && (
          ...
          <div className="flex flex-col border border-white/20 p-6 rounded-xl gap-4">
            ...
            <div className="text-sm text-gray-400">
              Incluye todas las colecciones (imágenes, tareas, etc.) y usuarios
            </div>
          ...
          <div className="flex flex-col border border-white/20 p-6 rounded-xl gap-4">
            ...
            <div className="bg-amber-900/20 border border-amber-500/30 p-4 rounded-md flex gap-3">
              ...
              <div className="text-sm text-amber-200">
                <strong>Advertencia:</strong> Importar un backup sobrescribirá{" "}
                <strong>TODOS</strong> los datos actuales de todas las
                colecciones. Esta acción no se puede deshacer. Asegúrate de
